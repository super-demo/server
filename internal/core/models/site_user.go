...
type SiteUser struct {
	...
	SiteUserLevelId int            `json:"site_user_level_id" gorm:"column:site_user_level_id"`
...
type SiteUserJoinTable struct {
	...
	SiteUserLevelId int            `json:"site_user_level_id"`
...
type CreateSiteUserWithoutSignRequest struct {
	...
	SiteUserLevelId int    `json:"site_user_level_id" binding:"required,oneof=3 4 5"`
}
